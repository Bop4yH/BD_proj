...
type.getSelectedIndex()==0){
    ...
    if(check()){
      ...
      String sql = "insert into purchase (BARCODE,NAME,TYPE,USER_ID,QUANTITY,PRICE,AMOUNT) values ('"+barcode.getText()+"' ,'"+name.getText()+"' ,'"+type.getSelectedItem()+"' ,1 ,'"+quantity.getSelectedItem()+"' ,'"+cost_price.getText()+"' ,'"+amount.getText()+"' )";
        try {
...
type.getSelectedIndex()==0){
    ...
    String sql = "update purchase set NAME='"+name.getText()+"', TYPE='"+type.getSelectedItem()+"' , USER_ID=1 ,QUANTITY='"+quantity.getSelectedItem()+"' ,PRICE='"+cost_price.getText()+"',AMOUNT='"+amount.getText()+"' ";
    try {
        pre=con.prepareStatement(sql);
        pre.execute();
